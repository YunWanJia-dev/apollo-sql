...
VALUES
  ...
  ('ModifyNamespace', 'public+application'),
  ('ReleaseNamespace', 'public+application'),
  ('ModifyNamespace', 'public+application+DEV'),
  ('ReleaseNamespace', 'public+application+DEV'),
  ...
  ('ModifyNamespace', 'public+cloudpvp-dev.redis-config'),
  ('ReleaseNamespace', 'public+cloudpvp-dev.redis-config'),
  ('ModifyNamespace', 'public+cloudpvp-dev.redis-config+DEV'),
  ('ReleaseNamespace', 'public+cloudpvp-dev.redis-config+DEV'),
  ('CreateApplication', 'SystemRole'),
  ...
  ('ModifyNamespace', 'auth+application'),
  ('ReleaseNamespace', 'auth+application'),
  ('ModifyNamespace', 'auth+application+DEV'),
  ('ReleaseNamespace', 'auth+application+DEV'),
  ('CreateNamespace', 'gateway'),
  ('CreateCluster', 'gateway'),
  ('AssignRole', 'gateway'),
  ('ManageAppMaster', 'gateway'),
  ('ModifyNamespace', 'gateway+application'),
  ('ReleaseNamespace', 'gateway+application'),
  ('ModifyNamespace', 'gateway+application+DEV'),
  ('ReleaseNamespace', 'gateway+application+DEV'),
  ('CreateNamespace', 'lobby'),
  ('CreateCluster', 'lobby'),
  ('AssignRole', 'lobby'),
  ('ManageAppMaster', 'lobby'),
  ('ModifyNamespace', 'lobby+application'),
  ('ReleaseNamespace', 'lobby+application'),
  ('ModifyNamespace', 'lobby+application+DEV'),
  ('ReleaseNamespace', 'lobby+application+DEV'),
  ('CreateCluster', 'play'),
  ('CreateNamespace', 'play'),
  ('AssignRole', 'play'),
  ('ManageAppMaster', 'play'),
  ('ModifyNamespace', 'play+application'),
  ('ReleaseNamespace', 'play+application'),
  ('ModifyNamespace', 'play+application+DEV'),
  ('ReleaseNamespace', 'play+application+DEV'),
  ('CreateNamespace', 'state'),
  ('AssignRole', 'state'),
  ('CreateCluster', 'state'),
  ('ManageAppMaster', 'state'),
  ('ModifyNamespace', 'state+application'),
  ('ReleaseNamespace', 'state+application'),
  ('ModifyNamespace', 'state+application+DEV'),
  ('ReleaseNamespace', 'state+application+DEV'),
  ('CreateNamespace', 'user-summary'),
  ('CreateCluster', 'user-summary'),
  ('AssignRole', 'user-summary'),
  ('ManageAppMaster', 'user-summary'),
  ('ModifyNamespace', 'user-summary+application'),
  ('ReleaseNamespace', 'user-summary+application'),
  ('ModifyNamespace', 'user-summary+application+DEV'),
  ('ReleaseNamespace', 'user-summary+application+DEV');
